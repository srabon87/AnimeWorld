...
const Navbar = () => {
  ...
  return (
    <nav className=" shadow-lg py-4 px-6">
      <div className="container mx-auto flex justify-between items-center">
        {/* Logo */}
        <Link to="/" className="text-cyan-600 text-3xl font-bold">
          AnimeWorld
        </Link>
        ...
        >
          ...
          <li><Link to="/animelist" className="hover:text-sky-600">Anime List</Link></li>
